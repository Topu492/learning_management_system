...
@section('content')
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-6 wow fadeInLeft">
                        <div class="wsus__about_3_img">
                            ...
                            <img src="" alt="About us" class="about_3_large img-fluid w-100">
                    ...
                    <div class="col-lg-6 wow fadeInRight">
                        <div class="wsus__about_3_text">
                            ...
                            <br>
                            <a class="common_btn" href=""></a>                    
                            <div class="about_video">
                                <img src=" alt="Video" class="img-fluid w-100">
                                <span>live</span>
                                <a class="play_btn venobox" data-autoplay="true" data-vbtype="video"
                                    href="">
                                    <img src="" alt="Play" class="img-fluid">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="wsus__about_counter wsus__counter mt_120 xs_mt_100">
        <div class="container">
            <div class="wsus__counter_bg" style="background:">
                <div class="row">
